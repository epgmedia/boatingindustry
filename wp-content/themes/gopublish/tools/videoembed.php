...
class sno_videoembed extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( ! empty( $instance['embed-code'] ) ) {
			...
			$video       = preg_replace( $pattern, "height:" . $videoheight . "px", $video );
			$pattern     = "/width=\"[0-9]*\"/";
			...
			<div
				style="<?php if ( $instance['remove-padding'] == 'on' ) { ?>padding-left:10px;padding-right:10px;padding-bottom:10px;<?php } ?>width:100%;padding-top:6px;">
				<p><?php echo $instance['teaser']; ?></p></div><?php } ?>
	...
	function form( $instance ) {
		...
		<div style="float:left;width:230px;margin-right:20px;border-right:1px solid #aaaaaa;padding-right:10px;">
			...
			<p>Paste your embed code in the box below.
				<textarea id="<?php echo $this->get_field_id( 'embed-code' ); ?>"
						  name="<?php echo $this->get_field_name( 'embed-code' ); ?>" style="width: 95%;"
						  rows="6"><?php echo $instance['embed-code']; ?></textarea></p>


			<p>Description Text
				<textarea id="<?php echo $this->get_field_id( 'teaser' ); ?>"
						  name="<?php echo $this->get_field_name( 'teaser' ); ?>" style="width: 95%;"
						  rows="3"><?php echo $instance['teaser']; ?></textarea></p>
		...
		<div style="float:left;width:210px">
			...
			<p>
				<input class="colorwellembed<?php echo $number; ?>"
			...
			<script>
				...
				jQuery(document).ready(function () {
					...
					jQuery(".colorwellembed<?php echo $number; ?>").click(function () {
						jQuery('#snocolorpickerembed<?php echo $number; ?>').slideDown()
					});
				});
			</script>
