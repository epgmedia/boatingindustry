...
class sno_category extends WP_Widget {
		...
		if ( ( $instance['category'] == - 1 ) || ( $totalstories <= 0 ) ) {
			...
			if ( have_posts() ) : while ( have_posts() ) : the_post();
				...
				if ( $count <= $instance['number'] ) {
					...
					if ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Home Bottom Wide" ) ) {
						$photodisplaywidth = $instance['photowidth'];
						$thumbnailsize     = "home400";
					} else if ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Home Main Column" ) ) {
						$photodisplaywidth = $instance['photowidth'];
						$thumbnailsize     = "permalink";
					} else if ( ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Home Bottom Right" ) ) || ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Home Bottom Left" ) ) ) {
						$photodisplaywidth = $instance['photowidth'];
						$thumbnailsize     = "home280";
					} else if ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Home Bottom Narrow" ) ) {
						$photodisplaywidth = $instance['photowidth'];
						$thumbnailsize     = "home160";
					} else if ( ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Home Sidebar" ) ) || ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Non-Home Sidebar" ) ) || ( ( $instance['category-photo-size'] == "Large" ) && ( $instance['sidebarname'] == "Sports Center Sidebar" ) ) ) {
						$photodisplaywidth = $instance['photowidth'];
						$thumbnailsize     = "permalink";
					}

					if ( ( $instance['category-photo-size'] == "Small" ) && ( $instance['sidebarname'] == "Home Bottom Wide" ) ) {
						$photodisplaywidth = get_option( 'home_narrow_column' );
						$thumbnailsize     = "home160";
					} else if ( ( $instance['category-photo-size'] == "Small" ) && ( $instance['sidebarname'] == "Home Main Column" ) ) {
						$photodisplaywidth = get_option( 'home_narrow_column' );
						$thumbnailsize     = "home160";
					} else if ( ( $instance['category-photo-size'] == "Small" ) && ( $instance['sidebarname'] == "Home Bottom Narrow" ) ) {
						$photodisplaywidth = get_option( 'home_narrow_column' );
						$thumbnailsize     = "home160";
					...
					if ( ( $instance['category-photo-size'] == "Medium" ) && ( $instance['sidebarname'] == "Home Bottom Wide" ) ) {
						$photodisplaywidth = 200;
						$thumbnailsize     = "archive";
					} else if ( ( $instance['category-photo-size'] == "Medium" ) && ( $instance['sidebarname'] == "Home Main Column" ) ) {
						$photodisplaywidth = 200;
						$thumbnailsize     = "archive";
					...
					if (
						(
							( $photodisplaywidth == get_option( 'home_right_column' ) ) &&
							( $instance['sidebarname'] == "Home Sidebar" )
						) ||
						(
							( $photodisplaywidth == get_option( 'home_narrow_column' ) ) &&
						...
						(
							( $photodisplaywidth == get_option( 'non_home_right_column' ) ) &&
							( $instance['sidebarname'] == "Non-Home Sidebar" )
						) ||
						(
							( $photodisplaywidth == get_option( 'non_home_right_column' ) ) &&
						...
						(
							( $photodisplaywidth == get_option( 'home_left_column' ) ) &&
							( $instance['sidebarname'] == "Home Bottom Left" )
						) ||
						(
							( $photodisplaywidth == get_option( 'home_center_column' ) ) &&
							( $instance['sidebarname'] == "Home Bottom Right" )
						) ||
						(
							( $photodisplaywidth == get_option( 'home_wide_column' ) ) &&
							( $instance['sidebarname'] == "Home Bottom Wide" )
						)
					) {
						$marginkey = 3;
					...
					if ( ( $marginkey !== 3 ) && ( $photocheck == 5 ) ) {
						...
						<div class="catboxthumbnail" style="float:<?php echo $instance['category-photo-placement']; ?>; width: <?php echo $photodisplaywidth; ?>px !important; margin-<?php echo $instance['category-photo-placement']; ?>:0;">
					...
					<?php if ( ( $instance['category-photo-size'] == "Large" ) && ( has_post_thumbnail() ) ) {
						$catimage = wp_get_attachment_image_src( get_post_thumbnail_id(), 'home400' ); ?><a
						href="<?php the_permalink(); ?>"><img src="<?php echo $catimage[0]; ?>" style="width:100%"
															  class="catboxphoto" alt="<?php the_title(); ?>" />
						</a><?php
					...
					if ( $instance['show-caption'] == 'on' ) {
						...
						if ( $photographer ) {
							?><p class="photocredit">Photo Credit: <?php echo $photographer; ?></p>
						<?php
						}
						$caption = get_post_meta( $post->ID, 'caption', true ); ?><p class="photocaption"
																					 style="padding-bottom:8px !important"><?php echo $caption; ?></p>
					<?php
					}
					if ( isset( $marginkey ) && ( $marginkey != 3 ) && ( $photocheck == 5 ) ) {
						?></div><?php
					}
					...
					if ( ( $writer ) && ( $instance['show-writer'] == 'on' ) ) {
						?><p
					...
					if ( ( $instance['show-date'] == 'on' ) || ( ( get_theme_mod( 'comments' ) == "Enable" ) && ( $instance['show-comments'] == 'on' ) ) || ( is_user_logged_in() ) ) {
						...
						if ( ( get_theme_mod( 'comments' ) == "Enable" ) && ( $instance['show-comments'] == 'on' ) ) {
					...
					<?php if ( ( $count >= 1 ) && ( $count < $totalstories ) && ( $totalstories != 1 ) ) { ?><?php if ( $instance['dividing-line'] == 'on' ) { ?>
				...
				<?php } else { ?><!--end of first time through loop-->
					...
					<?php if ( $instance['bullet-list'] == 'on' ) { ?>
						...
						<li><a class="homeheadline"
							   href="<?php the_permalink(); ?>"><?php the_title(); ?></a><?php if ( $instance['teaser-date'] == 'on' ) { ?><?php the_time( ' F j, Y' ); ?><?php } ?>
						</li>
					<?php } else { ?>
						...
						<?php if ( $instance['teaser-thumb'] == 'on' ) {
							...
							if ( has_post_thumbnail() ) {
								the_post_thumbnail( 'homethumb', array( 'class' => 'catboxthumb', 'style' => 'margin-bottom:10px; float:' . $thumbplacement . '; margin-' . $thumbplacement . ':0;' ) );
							} else if ( $feature_photo ) {
								?><a href="<?php the_permalink(); ?>"><img src="<?php echo $feature_photo; ?>"
																		   class="catboxthumb"
																		   style="float:<?php echo $thumbplacement; ?>;margin-bottom:10px;margin-<?php echo $thumbplacement; ?>:0;width:70px" />
								</a><?php
							} else {
								global $wpdb;
								...
								if ( $attachment ) {
									?><a href="<?php the_permalink(); ?>"><img src="<?php echo $attachment; ?>"
																			   class="catboxthumb"
																			   style="float:<?php echo $thumbplacement; ?>;margin-bottom:10px;margin-<?php echo $thumbplacement; ?>:0;width:70px" />
									</a><?php
								}
						...
						<?php } ?>
						<p><a class="homeheadline" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
			...
			if ( $instance['view-all'] == 'on' ) {
				...
				<a href="<?php echo cat_id_to_slug( $instance['category'] ); ?>"><p class="viewall">View All <span
							class="arrows"> &raquo;</span></p></a>
			<?php } ?>
			...
			<div
				...
				<?php } ?>class="widgetfooter<?php if ( $instance['widget-style'] == "Style 3" ) { ?>3<?php } else { ?>1<?php } ?>"></div></div>
	...
	function form( $instance ) {
		...
		<?php $categorytitle = cat_id_to_name( $instance['category'] ); ?><input type="hidden"
		...
		<p>
			<input id="<?php echo $this->get_field_id( 'number' ); ?>"
				   name="<?php echo $this->get_field_name( 'number' ); ?>" type="text" maxlength="1" size="1"
			...
			<select id="<?php echo $this->get_field_id( 'category-photo-placement' ); ?>"
				...
				<option
					value="Left" <?php if ( 'Left' == $instance['category-photo-placement'] ) {
					echo 'selected="selected"';
				} ?>>
					Left
				</option>
				<option
					value="Right" <?php if ( 'Right' == $instance['category-photo-placement'] ) {
					echo 'selected="selected"';
				} ?>>
					Right
				</option>
			...
			<select id="<?php echo $this->get_field_id( 'category-photo-size' ); ?>"
				...
				<option
					value="Small" <?php if ( 'Small' == $instance['category-photo-size'] ) {
					echo 'selected="selected"';
				} ?>>
					Small
				</option>
				<option
					value="Medium" <?php if ( 'Medium' == $instance['category-photo-size'] ) {
					echo 'selected="selected"';
				} ?>>
					Medium
				</option>
				<option
					value="Large" <?php if ( 'Large' == $instance['category-photo-size'] ) {
					echo 'selected="selected"';
				} ?>>
					Large
				</option>
			...
			<br />
			<input class="checkbox" type="checkbox" <?php if ( $instance['show-caption'] == 'on' ) {
				echo 'checked';
			} ?>
			...
			<input class="checkbox" type="checkbox" <?php if ( $instance['show-writer'] == 'on' ) {
				echo 'checked';
			} ?>
			...
			<input class="checkbox" type="checkbox" <?php if ( $instance['show-date'] == 'on' ) {
				echo checked;
			} ?>
			...
			<input class="checkbox" type="checkbox" <?php if ( $instance['show-comments'] == 'on' ) {
				echo checked;
			} ?>
			...
			<input id="<?php echo $this->get_field_id( 'category-teaser' ); ?>"
				   name="<?php echo $this->get_field_name( 'category-teaser' ); ?>" type="text" maxlength="3" size="3"
			...
			<br />
			<input class="checkbox" type="checkbox" <?php if ( $instance['dividing-line'] == 'on' ) {
				echo checked;
			} ?>
		...
		<p>
			<input class="checkbox" type="checkbox" <?php if ( $instance['headline-header'] == 'on' ) {
				echo checked;
			} ?>
			...
			<input class="checkbox" type="checkbox" <?php if ( $instance['bullet-list'] == 'on' ) {
				echo checked;
			} ?>
			...
			<input id="<?php echo $this->get_field_id( 'number-headlines' ); ?>"
				   name="<?php echo $this->get_field_name( 'number-headlines' ); ?>" type="text" maxlength="1"
				   size="1" value="<?php echo $instance['number-headlines']; ?>" />
			<label
			...
			<input id="<?php echo $this->get_field_id( 'headline-teaser' ); ?>"
				   name="<?php echo $this->get_field_name( 'headline-teaser' ); ?>" type="text" maxlength="3" size="3"
				   value="<?php echo $instance['headline-teaser']; ?>" />
			<label for="<?php echo $this->get_field_id( 'headline-teaser' ); ?>">Teaser Length
				(characters)</label><br />

			<input class="checkbox" type="checkbox" <?php if ( $instance['teaser-thumb'] == 'on' ) {
				echo checked;
			} ?>
			...
			<select id="<?php echo $this->get_field_id( 'teaser-thumb-placement' ); ?>"
				...
				<option
					value="left" <?php if ( 'left' == $instance['teaser-thumb-placement'] ) {
					echo 'selected="selected"';
				} ?>>
					Left
				</option>
				<option
					value="right" <?php if ( 'right' == $instance['teaser-thumb-placement'] ) {
					echo 'selected="selected"';
				} ?>>
					Right
				</option>
			...
			<input class="checkbox" type="checkbox" <?php if ( $instance['teaser-date'] == 'on' ) {
				echo checked;
			} ?>
			...
			<input class="checkbox" type="checkbox" <?php if ( $instance['view-all'] == 'on' ) {
				echo checked;
			} ?>
		...
		<div style="float:left;width:210px">
			...
			<p>
				<input class="checkbox" type="checkbox" <?php if ( $instance['custom-colors'] == 'on' ) {
					echo checked;
				} ?>
			...
			<p>
				...
				<input class="colorwellcat<?php echo $number; ?>" id="<?php echo $this->get_field_id( 'header-text' ); ?>"
