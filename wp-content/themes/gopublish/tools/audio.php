...
class sno_audio extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( ( $instance['category'] == - 1 ) || ( $instance['number'] <= 0 ) ) {
			...
			<?php $count = 0;
			$recent      = new WP_Query( 'cat=' . $instance['category'] . '&showposts=' . $instance['number'] );
			while ( $recent->have_posts() ) : $recent->the_post(); ?>
				...
				<a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>"><h3
						class="homeheadline"
			...
			<div
				...
				<?php } ?>class="widgetfooter<?php if ( $instance['widget-style'] == "Style 3" ) { ?>3<?php } else { ?>1<?php } ?>"></div></div><?php
		}
	}
