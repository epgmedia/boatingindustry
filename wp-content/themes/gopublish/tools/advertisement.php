...
class sno_rightad extends WP_Widget {
		...
		if ( ! empty( $instance['godengo-adtag'] ) ) {
			...
			if ( $instance['sidebarname'] == "Ads Sidebar" ) {
				...
				<div class="widgetwrap"
					 style="-moz-box-shadow: none !important; -webkit-box-shadow: none !important; box-shadow: none !important;">
				<?php if ( $showtitle == 'on' ) { ?>
				...
				<?php } ?>
				<div class="widgetbody3" style="background:none !important;padding:0!important;">
					<?php
					if ($instance['ad-type'] == "Ad Tag") {

						//SWW Mod to target ads for Top 100 & MDCE sections
						$openxcode = $instance['godengo-adtag'];
						...
						?>
						<a target="_blank" href="<?php echo $instance['link_url']; ?>">
							<img src="<?php echo $instance['ad_url']; ?>"
								 style="width:<?php echo $instance['adwidth']; ?>" />
						</a>
				...
				<?php if ( $showtitle == 'on' ) { ?>
					<div <?php if ( $customcolors == 'on' ) { ?>
						style="background-color:<?php echo $instance['header-color']; ?> !important;"<?php } ?>
						class="widgetfooter3">
					</div>
				<?php } else { ?>
				...
				<div class="widgetwrap">
					...
					<div class="widgetbody3" <?php if ( $customcolors == 'on' ) { ?> style="
						...
						if ( $instance['ad-type'] == "Ad Tag" ) {
							?>
							<div class="adcenter"><?php echo $instance['godengo-adtag']; ?></div>

						<?php } else if ( ! empty( $instance['link_url'] ) ) { ?>
							<a target="_blank" href="<?php echo $instance['link_url']; ?>">
								<img src="<?php echo $instance['ad_url']; ?>"
									 style="width:<?php echo $instance['adwidth']; ?>" />
							</a>
	...
	function form( $instance ) {
		...
		<div style="float:left;width:230px;margin-right:20px;border-right:1px solid #aaaaaa;padding-right:10px;">
			...
			<p>
				<select id="<?php echo $this->get_field_id( 'ad-type' ); ?>"
					...
					<option
						value="Static Ad" <?php if ( 'Static Ad' == $instance['ad-type'] ) {
			...
			<p>
				Upload your <strong><?php echo $instance['sidebarsize']; ?> ad</strong> by clicking the button below.
				After the image uploads, make sure the "Full Size" button is checked and then click "Insert into Post".
			</p>

			<p>
				<input class="upload_image_button_ad<?php echo $number; ?> button-primary" type="button"
					   value="Click to Upload Image" />
				<input class="upload_image_ad<?php echo $number; ?>" type="text"
					   id="<?php echo $this->get_field_id( 'ad_url' ); ?>"
					   name="<?php echo $this->get_field_name( 'ad_url' ); ?>" style="width: 95%;"
					   value="<?php echo $instance['ad_url']; ?>" />
			</p>

			<p>
				If you want the advertisement to link to another Website, add a link in the box below.
			</p>

			<p>
				<label for="<?php echo $this->get_field_id( 'link_url' ); ?>"><?php _e( 'Advertisement Link' ); ?>:</label>
				<br />
				<input id="<?php echo $this->get_field_id( 'link_url' ); ?>"
					   name="<?php echo $this->get_field_name( 'link_url' ); ?>" style="width: 95%;"
					   value="<?php echo $instance['link_url']; ?>" />
			</p>
		...
		<div style="float:left;width:230px;margin-right:20px;border-right:1px solid #aaaaaa;padding-right:10px;">
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'godengo-adtag' ); ?>"><?php _e( 'Paste Ad Tag Here' ); ?>
					:</label>
				<br />
				<textarea id="<?php echo $this->get_field_id( 'godengo-adtag' ); ?>"
						  name="<?php echo $this->get_field_name( 'godengo-adtag' ); ?>" style="width: 95%;" rows="9">
					<?php echo $instance['godengo-adtag']; ?>
				</textarea>
			</p>
		...
		<div style="float:left;width:210px">
			...
			<p>
				<input class="checkbox" type="checkbox" <?php if ( $instance['show-title'] == 'on' ) {
					echo 'checked';
				} ?>
			...
			<p>
				Save this widget to make the color selector active.
			</p>

			<p>
				<input class="colorwellad<?php echo $number; ?>" id="<?php echo $this->get_field_id( 'header-color' ); ?>"
					   name="<?php echo $this->get_field_name( 'header-color' ); ?>" type="text" maxlength="7" size="7"
					   value="<?php echo $instance['header-color']; ?>" /> Header Bar
				<br />
				<input class="colorwellad<?php echo $number; ?>" id="<?php echo $this->get_field_id( 'header-text' ); ?>"
					   name="<?php echo $this->get_field_name( 'header-text' ); ?>" type="text" maxlength="7" size="7"
					   value="<?php echo $instance['header-text']; ?>" /> Header Bar Text
				<br />
				<input class="colorwellad<?php echo $number; ?>"
					   ...
					   value="<?php echo $instance['widget-border']; ?>" /> Border
				<br />
				<input class="colorwellad<?php echo $number; ?>"
			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function () {
					jQuery('#snocolorpickerad<?php echo $number; ?>')
						.hide();
					jQuery('#snocolorpickerad<?php echo $number; ?>')
						.farbtastic(".colorwellad<?php echo $number; ?>");
					jQuery(".colorwellad<?php echo $number; ?>")
						.click(function () {
			...
			<p>
				You must save this widget before the image uploader will work.
			</p>
