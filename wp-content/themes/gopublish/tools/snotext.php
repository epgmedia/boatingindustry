...
class sno_text extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div
			...
			<?php } ?>class="widgetfooter<?php if ( $instance['widget-style'] == "Style 3" ) { ?>3<?php } else { ?>1<?php } ?>"></div>
		</div>
	<?php
	}
	...
	function form( $instance ) {
		...
		<div style="float:left;width:230px;margin-right:20px;border-right:1px solid #aaaaaa;padding-right:10px;">
			...
			<p>
				...
				<textarea id="<?php echo $this->get_field_id( 'text' ); ?>"
						  ...
						  rows="9"><?php echo $instance['text']; ?></textarea>
			</p>
		...
		<div style="float:left;width:210px">
			...
			<p>
				<input class="colorwelltext<?php echo $number; ?>"
			...
			<script>
				...
				jQuery(document).ready(function () {
					...
					jQuery(".colorwelltext<?php echo $number; ?>").click(function () {
						jQuery('#snocolorpickertext<?php echo $number; ?>').slideDown()
					});
				});
			</script>
