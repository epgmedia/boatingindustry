...
class epg_interstitial_ads {
    ...
    public function __construct() {
		...
		$this->dir_uri = get_template_directory_uri() . '/inc/interstitial-ad';
		...
		/** Cookie */
        if ( isset( $_COOKIE['interstitial_ad_bin'] ) ) {
            $this->visitCookie = $_COOKIE['interstitial_ad_bin'];
			$this->data['ad_cookie'] = $_COOKIE['interstitial_ad_bin'];
        }

		$this->data['ad_position'] = '/35190362/BIN_ROS_Roadblock';
