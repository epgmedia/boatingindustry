<?php
/*
Template Name: Email Subscription - BI
*/
?>
...
<form method="post" name="profileform" action="https://EPGMediaLLC.informz.net/clk/remote_post.asp">
  <table width="830" cellspacing="10" cellpadding="0" bgcolor="#ffffff" border="0">
...
<tr>
   <td colspan="2"  bgcolor="#214b7b" align="left">
		<b><font face="Arial" color="#ffffff" size=4>&nbsp;Information about you:</font></b>
	</td>
</tr>
<tr>
  <td colspan="2" width="100%">
    <table width="809" cellspacing="4" cellpadding="0" bgcolor="#ffffff" border="0">
      <tr>
        <td width="43%" nowrap valign="top"  align="left" >
          <font face=Arial size=3 color="#000000">Email:<FONT COLOR="RED">*</FONT></font>&nbsp;
        </td>
        <td width="57%" align="left" valign="top"><font face=Arial size=3 color="#000000">	
        ...
        <tr>
          <td valign="top"  align="left"  width='43%' >
            <font face=Arial size=3 color="#000000">Address 1:
            <font color="red">*</font></font>&nbsp;
          </td>
  
            <td align="left" valign="top"  width='57%' >
              <input alt="Address 1" type="text" name="personal_6149" value="" size="30" maxlength="500">
            </td>
          </tr>
        <tr>
          <td valign="top"  align="left"  width='43%' >
            <font face=Arial size=3 color="#000000">Address 2:
            </font>&nbsp;
          </td>
  
            <td align="left" valign="top"  width='57%' >
              <input alt="Address 2" type="text" name="personal_6150" value="" size="30" maxlength="500">
            </td>
          </tr>
        <tr>
          <td valign="top"  align="left"  width='43%' >
            <font face=Arial size=3 color="#000000">City:
            <font color="red">*</font></font>&nbsp;
          </td>
  
            <td align="left" valign="top"  width='57%' >
              <input alt="City" type="text" name="personal_6151" value="" size="30" maxlength="500">
            </td>
          </tr>
          <tr>
            <td valign="top"  align="left"  width='43%' >
              <font face=Arial size=3 color="#000000">State:
        ...
        <tr>
          <td valign="top"  align="left"  width='43%' >
            <font face=Arial size=3 color="#000000">Zip Code:
            <font color="red">*</font></font>&nbsp;
          </td>
          ...
          <tr>
            ...
            <tr>
               <td colspan="2"  bgcolor="#214b7b" align="left">
                    <b><font face="Arial" color="#ffffff" size=4>&nbsp;Information about your company:</font></b>
                </td>
            </tr>
          <td valign="top"  align="left"  width='43%' >
            <font face=Arial size=3 color="#000000">Company:
            </font>&nbsp;
          </td>
  
            <td align="left" valign="top"  width='57%' >
              <input alt="Company" type="text" name="personal_5786" value="" size="30" maxlength="500">
            </td>
          </tr>
          <tr>
            <td valign="top"  align="left">
              <font face=Arial size=3 color="#000000">What is your primary business activity:
            ...
            <td align="left" valign=top>
                  ...
                  <select name="demo_865" size="1">
    
                        <option value="">[Not Specified]</option>
        
                      <option value="38621">Boat & Motor Dealers</option>
      
                      <option value="38622">Marina Owners & Boat & Motor Dealers</option>
      
                      <option value="38623">Accesory Store and/or Chandlery</option>
      
                      <option value="38624">Marine Service & Repair Yard</option>
      
                      <option value="38625">Boatyard-Service and Maintenance yards</option>
      
                      <option value="38626">Marinas/Boatyards</option>
      
                      <option value="38627">Port/Harbor Management</option>
      
                      <option value="38628">Other Marina & Retailing Management</option>
      
                      <option value="38629">Boat/Yacht Builders</option>
      
                      <option value="38630">Marina Design/Development</option>
      
                      <option value="38631">Naval/Marine Architect/Yacht Design</option>
      
                      <option value="38632">Marine Product/Accessory Mfgs.</option>
      
                      <option value="38633">Marine Wholesalers or Distributors or Jobbers</option>
      
                      <option value="38634">Marine Mfg. Representative</option>
      
                      <option value="38635">Import/Export Firm</option>
      
                      <option value="38636">Consultants</option>
      
                      <option value="38637">Government/Regulatory Agencies</option>
      
                      <option value="38638">Military/Law Enforcement Agencies</option>
      
                      <option value="38639">Marine Training/Educational Institutions</option>
      
                      <option value="38640">Marine Scientific/University Institutions</option>
      
                      <option value="38641">Marine Associations</option>
      
                      <option value="38642">Others</option>
        ...
        <tr>
          <td valign="top"  align="left"  width='43%' >
            <font face=Arial size=3 color="#000000">Title:
            <font color="red">*</font></font>&nbsp;
          </td>
  
            <td align="left" valign="top"  width='57%' >
              <input alt="Title" type="text" name="personal_6147" value="" size="30" maxlength="500">
            </td>
          </tr>
          <tr>
            <td valign="top"  align="left"  width='43%' >
              <font face=Arial size=3 color="#000000">Do you influence the purchase or specification or materials or equipment used in the boating industry?:
            ...
            <td align="left"  width='57%' valign=bottom >
                    ...
                    <input alt="Yes" type=radio name="demo_866" value=""><font face=Arial size=3 color="#000000">Not Specified</font><br>
  
                      <input alt="Yes" type=radio name="demo_866" value="38643"><font face=Arial size=3 color="#000000">Yes</font><br>
                      <input alt="No" type=radio name="demo_866" value="38644"><font face=Arial size=3 color="#000000">No</font><br>
            </td>
          </tr>
...
<tr>
   <td colspan="2"  bgcolor="#214b7b" align="left">
		<b><font face="Arial" color="#ffffff" size=4>&nbsp;Select your interests:</font></b>
	</td>
</tr><tr><td colspan="2"><table cellpadding="3"><tr><td width="577"><a href='#' onClick="ShowDescriptions('http://EPGMediaLLC.informz.net/EPGMediaLLC',64928,0); return false;"><font face=Arial size=3 color="#000000">Boating Industry Newsletters and Communications</font></td><td width="42"><input alt="Boating Industry Newsletters and Communications" type="checkbox" value="64928" name="interests" ></td></tr><tr><td width="577"><a href='#' onClick="ShowDescriptions('http://EPGMediaLLC.informz.net/EPGMediaLLC',65464,0); return false;"><font face=Arial size=3 color="#000000">Marine Dealer Conference & Expo Newsletters and Communications</font></td><td><input alt="Marine Dealer Conference & Expo Newsletters and Communications" type="checkbox" value="65464" name="interests" ></td></tr><tr><td width="577"><a href='#' onClick="ShowDescriptions('http://EPGMediaLLC.informz.net/EPGMediaLLC',65080,0); return false;"><font face=Arial size=3 color="#000000">Email communications from other boating related companies</font></td><td><input alt="Email communications from other boating related companies" type="checkbox" value="65080" name="interests" ></td></tr><input type="hidden" name="OptoutInfo" value=""></table><font face=Arial size=3 color="#000000"><font size="1">You will receive tailored information according to your interests.</font><font face=Arial size=3 color="#000000"></td></tr>
  <tr>
...
<input type=hidden name=fid value=2088>
<input type=hidden name=b value=3678>
<input type=hidden name=returnUrl value="http://www.boatingindustry.com/you-are-subscribed/?zmsg=1">
</form>
