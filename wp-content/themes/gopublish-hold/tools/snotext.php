		...
		echo '<div class="widgetwrap">'; ?>
			<?php 
				...
				foreach ($sidebartest["sidebar-6"] as $key => $value ) { 
					if ($widget == $value) $instance['sidebarname'] = 'Sports Center Sidebar'; 
					}
			?>							
