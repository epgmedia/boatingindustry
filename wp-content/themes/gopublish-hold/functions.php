...
add_action( 'init', 'register_cpt_sng_press_release' );

function register_cpt_sng_press_release() {

    $labels = array(
        'name' => _x( 'Press Releases', 'sng_press_release' ),
        'singular_name' => _x( 'Press Release', 'sng_press_release' ),
        'add_new' => _x( 'Add New', 'sng_press_release' ),
        'add_new_item' => _x( 'Add New Press Release', 'sng_press_release' ),
        'edit_item' => _x( 'Edit Press Release', 'sng_press_release' ),
        'new_item' => _x( 'New Press Release', 'sng_press_release' ),
        'view_item' => _x( 'View Press Release', 'sng_press_release' ),
        'search_items' => _x( 'Search Press Releases', 'sng_press_release' ),
        'not_found' => _x( 'No press releases found', 'sng_press_release' ),
        'not_found_in_trash' => _x( 'No press releases found in Trash', 'sng_press_release' ),
        'parent_item_colon' => _x( 'Parent Press Release:', 'sng_press_release' ),
        'menu_name' => _x( 'Press Releases', 'sng_press_release' ),
    );

    $args = array(
        'labels' => $labels,
        'hierarchical' => false,
        'description' => 'Press Releases on SnowGoer.com',
    ...
    register_post_type( 'sng_press_release', $args );
}